...
face_cascade = cv2.CascadeClassifier( '/home/raspc/opencv-3.3.0/data/lbpcascades/lbpcascade_frontalface.xml' ) 
...
for frame in camera.capture_continuous( rawCapture, format="bgr", use_video_port=True ):
    ...
    for ( x, y, w, h ) in faces:
        ...
        cv2.putText( image, "TieTouWa No." + str( len( faces ) ), ( x, y ), cv2.FONT_HERSHEY_SIMPLEX, 0.5, ( 0, 0, 255 ), 2 )
